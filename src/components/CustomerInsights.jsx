    ...
    <div>
      <div className="flex flex-col lg:flex-row p-6 gap-6">
        ...
        <div className="w-full lg:w-3/4 flex flex-col gap-6">
          <img
            src="https://fastwpdemo.com/demo/consultive/wp-content/uploads/2022/05/customer-lnsignts.jpg"
            alt="Business Growth"
          ...
          <div className="text-gray-700 space-y-4 text-sm leading-6">
            <p>
              We work closely with Employers across all industry sectors to
              ensure that their internal sed Human Resource systems processes
              align to their business requirements idea of denouncing pleasure
